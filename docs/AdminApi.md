...
# **admin_create_hook**
> ::models::Hook admin_create_hook(ctx, ctx, ctx, ctx, ctx, ctx, ctx, body)
Create a hook
...
# **admin_delete_hook**
> admin_delete_hook(ctx, ctx, ctx, ctx, ctx, ctx, ctx, id)
Delete a hook
...
# **admin_delete_user**
> admin_delete_user(ctx, ctx, ctx, ctx, ctx, ctx, ctx, username, optional)
Delete a user
...
# **admin_edit_hook**
> ::models::Hook admin_edit_hook(ctx, ctx, ctx, ctx, ctx, ctx, ctx, id, optional)
Update a hook
...
> Vec<::models::Email> admin_get_all_emails(ctx, ctx, ctx, ctx, ctx, ctx, ctx, optional)
List all emails
...
# **admin_get_hook**
> ::models::Hook admin_get_hook(ctx, ctx, ctx, ctx, ctx, ctx, ctx, id)
Get a hook
...
# **admin_list_hooks**
> Vec<::models::Hook> admin_list_hooks(ctx, ctx, ctx, ctx, ctx, ctx, ctx, optional)
...
# **admin_rename_user**
> admin_rename_user(ctx, ctx, ctx, ctx, ctx, ctx, ctx, username, body)
Rename a user
...
# **admin_search_emails**
> Vec<::models::Email> admin_search_emails(ctx, ctx, ctx, ctx, ctx, ctx, ctx, optional)
Search all emails
...
# **admin_search_users**
> Vec<::models::User> admin_search_users(ctx, ctx, ctx, ctx, ctx, ctx, ctx, optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **source_id** | **i64**| ID of the user&#39;s login source to search for | 
