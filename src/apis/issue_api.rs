...
pub trait IssueApi {
    ...
    fn issue_create_issue_attachment(&self, owner: &str, repo: &str, index: i64, attachment: ::models::File, name: &str) -> Box<Future<Item = ::models::Attachment, Error = Error<serde_json::Value>>>;
    fn issue_create_issue_blocking(&self, owner: &str, repo: &str, index: &str, body: ::models::IssueMeta) -> Box<Future<Item = ::models::Issue, Error = Error<serde_json::Value>>>;
    fn issue_create_issue_comment_attachment(&self, owner: &str, repo: &str, id: i64, attachment: ::models::File, name: &str) -> Box<Future<Item = ::models::Attachment, Error = Error<serde_json::Value>>>;
    fn issue_create_issue_dependencies(&self, owner: &str, repo: &str, index: &str, body: ::models::IssueMeta) -> Box<Future<Item = ::models::Issue, Error = Error<serde_json::Value>>>;
    ...
    fn issue_delete_issue_attachment(&self, owner: &str, repo: &str, index: i64, attachment_id: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn issue_delete_issue_comment_attachment(&self, owner: &str, repo: &str, id: i64, attachment_id: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    ...
    fn issue_edit_issue_attachment(&self, owner: &str, repo: &str, index: i64, attachment_id: i64, body: ::models::EditAttachmentOptions) -> Box<Future<Item = ::models::Attachment, Error = Error<serde_json::Value>>>;
    fn issue_edit_issue_comment_attachment(&self, owner: &str, repo: &str, id: i64, attachment_id: i64, body: ::models::EditAttachmentOptions) -> Box<Future<Item = ::models::Attachment, Error = Error<serde_json::Value>>>;
    ...
    fn issue_get_issue_attachment(&self, owner: &str, repo: &str, index: i64, attachment_id: i64) -> Box<Future<Item = ::models::Attachment, Error = Error<serde_json::Value>>>;
    fn issue_get_issue_comment_attachment(&self, owner: &str, repo: &str, id: i64, attachment_id: i64) -> Box<Future<Item = ::models::Attachment, Error = Error<serde_json::Value>>>;
    ...
    fn issue_list_blocks(&self, owner: &str, repo: &str, index: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Issue>, Error = Error<serde_json::Value>>>;
    fn issue_list_issue_attachments(&self, owner: &str, repo: &str, index: i64) -> Box<Future<Item = Vec<::models::Attachment>, Error = Error<serde_json::Value>>>;
    fn issue_list_issue_comment_attachments(&self, owner: &str, repo: &str, id: i64) -> Box<Future<Item = Vec<::models::Attachment>, Error = Error<serde_json::Value>>>;
    fn issue_list_issue_dependencies(&self, owner: &str, repo: &str, index: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Issue>, Error = Error<serde_json::Value>>>;
    ...
    fn issue_remove_issue_blocking(&self, owner: &str, repo: &str, index: &str, body: ::models::IssueMeta) -> Box<Future<Item = ::models::Issue, Error = Error<serde_json::Value>>>;
    fn issue_remove_issue_dependencies(&self, owner: &str, repo: &str, index: &str, body: ::models::IssueMeta) -> Box<Future<Item = ::models::Issue, Error = Error<serde_json::Value>>>;
    ...
    fn issue_search_issues(&self, state: &str, labels: &str, milestones: &str, q: &str, priority_repo_id: i64, _type: &str, since: String, before: String, assigned: bool, created: bool, mentioned: bool, review_requested: bool, reviewed: bool, owner: &str, team: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Issue>, Error = Error<serde_json::Value>>>;
    ...
    fn move_issue_pin(&self, owner: &str, repo: &str, index: i64, position: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn pin_issue(&self, owner: &str, repo: &str, index: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn unpin_issue(&self, owner: &str, repo: &str, index: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>IssueApi for IssueApiClient<C> {
    ...
    fn issue_create_issue_attachment(&self, owner: &str, repo: &str, index: i64, attachment: ::models::File, name: &str) -> Box<Future<Item = ::models::Attachment, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/{index}/assets?{}", configuration.base_path, query_string, owner=owner, repo=repo, index=index);
    ...
    fn issue_create_issue_blocking(&self, owner: &str, repo: &str, index: &str, body: ::models::IssueMeta) -> Box<Future<Item = ::models::Issue, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/{index}/blocks?{}", configuration.base_path, query_string, owner=owner, repo=repo, index=index);
    ...
    fn issue_create_issue_comment_attachment(&self, owner: &str, repo: &str, id: i64, attachment: ::models::File, name: &str) -> Box<Future<Item = ::models::Attachment, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/comments/{id}/assets?{}", configuration.base_path, query_string, owner=owner, repo=repo, id=id);
    ...
    fn issue_create_issue_dependencies(&self, owner: &str, repo: &str, index: &str, body: ::models::IssueMeta) -> Box<Future<Item = ::models::Issue, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/{index}/dependencies?{}", configuration.base_path, query_string, owner=owner, repo=repo, index=index);
    ...
    fn issue_delete_issue_attachment(&self, owner: &str, repo: &str, index: i64, attachment_id: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/{index}/assets/{attachment_id}?{}", configuration.base_path, query_string, owner=owner, repo=repo, index=index, attachment_id=attachment_id);
    ...
    fn issue_delete_issue_comment_attachment(&self, owner: &str, repo: &str, id: i64, attachment_id: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id}?{}", configuration.base_path, query_string, owner=owner, repo=repo, id=id, attachment_id=attachment_id);
    ...
    fn issue_search_issues(&self, state: &str, labels: &str, milestones: &str, q: &str, priority_repo_id: i64, _type: &str, since: String, before: String, assigned: bool, created: bool, mentioned: bool, review_requested: bool, reviewed: bool, owner: &str, team: &str, page: i32, limit: i32) -> Box<Future<Item = Vec<::models::Issue>, Error = Error<serde_json::Value>>> {
        ...
        let query_string = {
            ...
            query.append_pair("reviewed", &reviewed.to_string());
    ...
    fn move_issue_pin(&self, owner: &str, repo: &str, index: i64, position: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/{index}/pin/{position}?{}", configuration.base_path, query_string, owner=owner, repo=repo, index=index, position=position);
    ...
    fn pin_issue(&self, owner: &str, repo: &str, index: i64) -> Box<Future<Item = (), Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/repos/{owner}/{repo}/issues/{index}/pin?{}", configuration.base_path, query_string, owner=owner, repo=repo, index=index);
